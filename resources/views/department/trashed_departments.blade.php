@extends('layout.main')
@section('title', 'Trashed Departments')
        ...
        <div class="page-header page-header-default">
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('departments.index') }}">Departments</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #37474f; border-color: #37474f;">
                            <h6 class="panel-title">Trashed Departments</h6>
                            {{--<div class="heading-elements">
                                <ul class="icons-list">
                            ...
                            @foreach($departments as $department)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        {!! Form::open(['id' => 'form_department_delete '.$department->id, 'method' => 'DELETE', 'route' => ['departments.destroy', $department->id], 'class' => 'form-horizontal']) !!}
                                        <ul class="icons-list">

                                            <li id="restore_department" title="Restore" class="text-primary-600"><a
                                                        href="{{ route('departments.restore', $department->id) }}"><i
