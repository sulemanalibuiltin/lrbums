                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #37474f; border-color: #37474f;">
                            <h6 class="panel-title">Add New Department</h6>
                            {{--<div class="heading-elements">
                                <ul class="icons-list">
                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::open(['class' => 'form-horizontal', 'id' => 'department_form' ,'method' => 'post', 'route' => 'departments.store']) !!}
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        <select name="department_type" class="bootstrap-select" data-width="100%">
                                            @foreach($department_types as $department_type)
                                                <option value="{{ $department_type->id }}">{{$department_type->title}}</option>
                                            @endforeach
