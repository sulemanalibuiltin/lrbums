                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #37474f; border-color: #37474f;">
                            <h6 class="panel-title">Designations</h6>
                            {{--<div class="heading-elements">
                                <ul class="icons-list">
                            ...
                            @foreach($designations as $designation)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        {!! Form::open(['id' => 'form_designation_delete '.$designation->id, 'method' => 'PUT', 'route' => ['designations.trash', $designation->id], 'class' => 'form-horizontal']) !!}
                                        <ul class="icons-list">

                                            <li id="edit_designation" title="Edit" class="text-primary-600"><a
