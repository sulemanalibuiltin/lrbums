                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #263238; border-color: #263238;">
                            <h6 class="panel-title">Edit Controller</h6>
                            {{--<div class="heading-elements">
                                <ul class="icons-list">
                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::open(['class' => 'form-horizontal', 'method' => 'put', 'route' => ['modules.update', $controller->id]]) !!}
                            <fieldset class="content-group">
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        {!! Form::text('title', $controller->title,['class' => 'form-control']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        ...
                                        {!!   Form::textarea('description', $controller->description, ['size' => '5x5', 'class' => 'form-control', 'placeholder' => '']) !!}
                                    </div>
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('route') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-lg-10">
                                        {{--<input type="text" class="form-control">--}}
                                        {!! Form::text('route', $controller->route, ['class' => 'form-control']) !!}
                                    ...
                                    <div class="col-lg-10">
                                        <label class="radio-inline radio-left">
                                            <input type="radio" name="menu_status" class="styled" value="1"
                                                   {{ ($controller->menu_status == 1) ? ' checked':'' }}>
                                            Show in menu
                                        </label>

                                        <label class="radio-inline radio-left">
                                            <input type="radio" name="menu_status" class="styled" value="0"
                                                    {{ ($controller->menu_status == 0) ? ' checked':'' }}>
                                            Don't show in menu
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        {{--<input type="text" class="form-control">--}}
                                        {!! Form::text('icon', $controller->icon, ['class' => 'form-control']) !!}
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-10">
                                        <label class="radio-inline radio-left">
                                            <input type="radio" name="status" class="styled" value="1"
                                                   {{ ($controller->status == 1) ? ' checked': '' }}>
                                            Active
                                        </label>

                                        <label class="radio-inline radio-left">
                                            <input type="radio" name="status" class="styled" value="0"
                                                    {{ ($controller->status == 0) ? ' checked': '' }}>
                                            Inactive
                                        </label>
                                    </div>
                                </div>
