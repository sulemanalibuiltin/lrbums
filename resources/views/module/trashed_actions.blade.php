        ...
        <div class="page-header page-header-default">
            <div class="page-header-content">
                ...
                <div class="heading-elements">
                    <div class="text-right">
                        ...
                        <a href="{{ route('actions.trashed', $controller_id) }}" class="btn bg-danger"><i class="fa fa-trash" style="margin-right: 6px;"></i>Trash</a>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('modules.actions', $controller_id) }}"> Actions</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #263238; border-color: #263238;">
                            <h6 class="panel-title">Trashed Actions</h6>
                            {{--<div class="heading-elements">
                                <ul class="icons-list">
                            ...
                            @foreach($actions as $action)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        {!! Form::open(['id' => 'form_module_delete '.$action->id,'method' => 'delete', 'route' => ['actions.destroy', $action->id], 'class' => 'form-horizontal']) !!}
                                        <ul class="icons-list">

                                            <li title="Restore" class="text-primary-300"><a href="{{ route('actions.restore', $action->id) }}"><i class="icon-undo2"></i></a></li>
                                            <li id="delete_module" title="Delete" data-toggle="modal" data-id="{{ 'form_module_delete '.$action->id }}" class="text-danger-600"><a href="javascript:void(0){{--{{ route('roles.destroy', $role['id']) }}--}}" ><i class="icon-trash-custom"></i></a></li>
                                        </ul>
                                        {!! Form::close() !!}
                                    </td>
                                </tr>
