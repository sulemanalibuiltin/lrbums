            ...
            <div class="page-header-content">
                ...
                <div class="heading-elements">
                    <div class="text-right">
                        <a href="{{ route('modules.create') }}" class="btn bg-primary"><i class="fa fa-plus"
                                                                                          style="margin-right:6px;"></i>New</a>

                        {{--{{ Form::button('<i class="fa fa-plus" style="margin-right:6px;"></i>New',['class'=>'btn bg-info']) }}--}}
                        <a href="{{ route('modules.trashed') }}" class="btn bg-danger"><i class="fa fa-trash"
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #263238; border-color: #263238;">
                            <h6 class="panel-title">Controllers</h6>
                            {{--<div class="heading-elements">
                                <ul class="icons-list">
                        ...
                        <table class="table datatable-responsive table-striped table-hover table-bordered">
                            ...
                            @foreach($controllers as $controller)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('modules.actions', [$controller->id]) }}">{{ $controller->title }}</a>
                                    ...
                                    @endif
                                    <td><i class="{{ $controller->icon }}"
                                           style="margin-right: 5px;"></i> {{ $controller->icon }}</td>
                                    ...
                                    <td class="text-center">
                                        ...
                                        {!! Form::open(['id' => 'form_module_delete '.$controller->id, 'method' => 'POST', 'route' => ['modules.trash', $controller->id], 'class' => 'form-horizontal']) !!}
                                        <ul class="icons-list">

                                            <li id="edit_module" title="Edit" class="text-primary-600"><a
                                                        href="{{ route('modules.edit', $controller->id) }}"><i
                                                            class="icon-pencil7"></i></a></li>

                                            <li id="delete_module" data-toggle="modal"
                                                data-id="{{ 'form_module_delete '.$controller->id }}"
                                                title="Delete"
