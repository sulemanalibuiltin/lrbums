@extends('layout.main')
@section('title','Trashed Controllers')
        ...
        <div class="page-header page-header-default">
            <div class="page-header-content">
                ...
                <div class="heading-elements">
                    <div class="text-right">
                        <a href="{{ route('modules.create') }}" class="btn bg-primary"><i class="fa fa-plus" style="margin-right:6px;"></i>New</a>

                        {{--{{ Form::button('<i class="fa fa-plus" style="margin-right:6px;"></i>New',['class'=>'btn bg-info']) }}--}}
                        <a href="{{ route('modules.trashed') }}" class="btn bg-danger"><i class="fa fa-trash" style="margin-right: 6px;"></i>Trash</a>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('modules.controllers') }}"> Controllers</a></li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #263238; border-color: #263238;">
                            <h6 class="panel-title">Trashed Controllers</h6>
                            {{--<div class="heading-elements">
                                <ul class="icons-list">
                        ...
                        <table class="table datatable-responsive table-striped table-hover table-bordered">
                            ...
                            @foreach($controllers as $controller)
                                <tr>
                                    ...
                                    <td><a href="#">{{ $controller->title }}</a></td>
                                    <td style="text-align: center;"><code>/{{ $controller->route }}</code></td>
                                    @if($controller->menu_status == 1)
                                        <td style="text-align: center;"><span class="label label-success">Enable</span>
                                        </td>
                                    @elseif($controller->menu_status == 0)
                                        <td style="text-align: center;"><span class="label label-default">Disable</span>
                                        </td>
                                    @endif
                                    <td><i class="{{ $controller->icon }}" style="margin-right: 5px;"></i> {{ $controller->icon }}</td>
                                    <td class="text-center">

                                        {!! Form::open(['id' => 'form_module_delete '.$controller->id,'method' => 'delete', 'route' => ['modules.destroy', $controller->id], 'class' => 'form-horizontal']) !!}
                                        <ul class="icons-list">

                                            <li title="Restore" class="text-primary-300"><a href="{{ route('modules.restore', $controller->id) }}"><i class="icon-undo2"></i></a></li>
                                            <li id="delete_module" title="Delete" data-toggle="modal" data-id="{{ 'form_module_delete '.$controller->id }}" class="text-danger-600"><a href="javascript:void(0){{--{{ route('roles.destroy', $role['id']) }}--}}" ><i class="icon-trash-custom"></i></a></li>
                                        </ul>
                                        {!! Form::close() !!}
                                    </td>
                                </tr>
