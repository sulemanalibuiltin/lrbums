        ...
        <div class="page-header page-header-default">
            <div class="page-header-content">
                <div class="page-title">
                    <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Actions</span>
                    </h4>
                </div>
            ...
            <div class="breadcrumb-line">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="{{ route('modules.actions', $parent_id) }}">Actions</a>
                    </li>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #263238; border-color: #263238;">
                            <h6 class="panel-title">Add New Action</h6>
                        ...
                        <div class="panel-body">
                            ...
                            {!! Form::open(['class' => 'form-horizontal', 'method' => 'post', 'route' => ['actions.store', $parent_id]]) !!}
